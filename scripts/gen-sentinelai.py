...
def build(repo: Path | None) -> dict:
    ...
    nodes = [
        ...
        n(
            ...
            "module",
            "Alert Engine",
            "Email, Telegram, Slack, Discord, Teams, webhook, SMS, push.",
            "backend/app/engines/alerts/channels.py",
            r("backend/app/engines/alerts/channels.py"),
            ["multicanal", "supressão manutenção", "SMS Twilio", "push Expo"],
        ),
        n(
            "sai-zion",
            "sai-root",
            "module",
            "Zion Hub",
            "Painéis operacionais por IP/métrica: cards, exclusões, refresh WMI/SNMP.",
            "frontend/src/pages/ZionPage.tsx",
            r("frontend/src/pages/ZionPage.tsx", "", 12000),
            ["criar painel", "adicionar métrica", "remover card", "toast 30s"],
        ),
        n(
            "sai-zion-api",
            "sai-zion",
            "file",
            "zion.py",
            "API REST dos painéis Zion.",
            "backend/app/api/routes/zion.py",
            r("backend/app/api/routes/zion.py"),
            ["CRUD panels", "DELETE card", "add metrics/devices"],
        ),
        n(
            "sai-zion-panels",
            "sai-zion",
            "file",
            "zion_panels.py",
            "Coleta SNMP/WMI/ports, serialize cards, card_exclusions.",
            "backend/app/services/zion_panels.py",
            r("backend/app/services/zion_panels.py", "", 12000),
            ["refresh_device_sensor_metrics", "remove_card_from_panel", "cpu_temp"],
        ),
        n(
            "sai-wmi",
            "sai-discovery-task",
            "file",
            "wmi_collector.py",
            "Coleta Windows via Impacket: hostname, vendor, CPU, RAM, disco, temp.",
            "backend/app/engines/discovery/wmi_collector.py",
            r("backend/app/engines/discovery/wmi_collector.py"),
            ["collect_wmi_info", "MSAcpi_ThermalZoneTemperature", "porta 135"],
        ),
        n(
            "sai-sse",
            "sai-root",
            "module",
            "Realtime SSE",
            "Stream de monitoramento (hoje in-memory; Fase 1 → Redis pub/sub).",
            "backend/app/services/realtime_events.py",
            r("backend/app/services/realtime_events.py"),
            ["event_bus", "/api/stream/monitoring", "useMonitoringStream"],
        ),
        n(
            "sai-stabilize",
            "sai-root",
            "module",
            "Estabilização Fase 0",
            "Baseline operacional, inventário honesto e backup Postgres/.env.",
            "docs/PHASE-0-BASELINE.md",
            r("docs/PHASE-0-BASELINE.md", "", 8000),
            ["SNMP 8/603", "CRONOGRAMA-ESTABILIZACAO", "backup-sentinel.ps1"],
        ),
        n(
            "sai-feature-inv",
            "sai-stabilize",
            ...
            "Inventário de features Map Editor + NMS + stabilization gaps.",
            "docs/feature-inventory.json",
            r("docs/feature-inventory.json", "", 6000),
            ["scripts/feature-inventory.py", "seção stabilization"],
        ),
    ]
    ...
    return {
        ...
        "summary": "NMS: discovery configurável, Zion, WMI/SNMP, inventário /24, mapa 2D/3D, estabilização Fase 0+.",
        "nodes": nodes,
    }
